        ...
        >
          <div className="flex justify-between items-center p-5 border-b border-slate-100 dark:border-slate-700 bg-red-50/50 dark:bg-red-500/10">
            <h3 className="text-lg font-bold text-red-600 dark:text-red-400 flex items-center gap-2">
              <Trash2 className="w-5 h-5"/> Hapus Anggaran
            </h3>
          ...
          <div className="p-6 space-y-4">
            <p className="text-slate-600 dark:text-slate-300">
              Apakah kamu yakin ingin menghapus anggaran ini? Riwayat pengeluaran tidak akan terhapus, namun batas anggarannya akan dihilangkan.
            </p>
